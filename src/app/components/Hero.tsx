      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left" >
            <h1 data-aos="fade-up" data-aos-delay="100" data-aos-duration="2000" data-aos-anchor-placement="top-center" className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Expert Apple Device Repair Service
            </h1>
            <p data-aos="fade-up" data-aos-delay="100" data-aos-duration="2000" className="text-lg sm:text-xl text-gray-600 mb-8 max-w-2xl mx-auto lg:mx-0">
              Professional repair for iPhone, iPad, and MacBook. Fast, reliable, and affordable service with certified technicians.
            </p>

            {/* Features */}
            <div className="space-y-3 mb-8" data-aos="fade-up" data-aos-delay="100" data-aos-duration="2000" data-aos-offset="200">
            ...
            {/* CTA Buttons */}
            <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="2000" className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="#contact"
          ...
          <div className="relative">
            <div data-aos="zoom-in" data-aos-delay="200" data-aos-duration="3000" className="rounded-2xl overflow-hidden shadow-2xl">
              <ImageWithFallback
